import { SSLApp, App, WebSocket, SHARED_COMPRESSOR, CompressOptions } from 'uWebSockets.js';
...
export function wrapper({port=9001, appOpts={}, wsOpts={}, onOpen, onMessage, onClose}:WrapperObj) {
    let _App = appOpts.key_file_name ? SSLApp : App;
